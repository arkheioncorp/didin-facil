...
- Interrupções sustentadas em discussões ou eventos
...
Este Código de Conduta aplica-se em todos os espaços da comunidade e também quando um indivíduo está representando oficialmente a comunidade em espaços públicos. Exemplos de representação da nossa comunidade incluem:

- Usar um endereço de e-mail oficial
- Postar via conta oficial de mídia social
- Atuar como representante designado em evento online ou offline
- Participar de discussões em nosso repositório GitHub
- Usar o software ou serviços relacionados

## Aplicação

### Reportando Incidentes

Casos de comportamento abusivo, assediante ou de outra forma inaceitável podem ser reportados para:

- **E-mail:** conduta@arkheioncorp.com
- **Formulário anônimo:** https://arkheioncorp.com/report
...
- Sua informação de contato (opcional se anônimo)
- Nomes (reais, apelidos ou pseudônimos) dos envolvidos
...
1. **Recebimento:** Confirmação em até 48 horas
2. **Investigação:** Análise imparcial dos fatos
3. **Decisão:** Determinação de ação apropriada
4. **Comunicação:** Notificação às partes envolvidas
5. **Apelação:** Direito de recorrer da decisão
...
**Consequência:** Banimento permanente de qualquer tipo de interação pública dentro da comunidade. Isso inclui:
- Remoção de acesso ao repositório
- Cancelamento de licenças sem reembolso
- Bloqueio de todas as contas associadas
...
- **E-mail geral:** suporte@arkheioncorp.com
- **Denúncias:** conduta@arkheioncorp.com
