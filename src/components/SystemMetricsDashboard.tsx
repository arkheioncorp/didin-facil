...
async function fetchMetrics(): Promise<SystemMetrics> {
  ...
  return {
    workers_active: extractMetric("didin_workers_active"),
    posts_pending: extractMetric("didin_posts_pending"),
    posts_processing: extractMetric("didin_posts_processing"),
    posts_completed: extractMetric("didin_posts_completed_total"),
    posts_failed: extractMetric("didin_posts_failed_total"),
    dlq_size: extractMetric("didin_dlq_size"),
    api_response_time_avg_ms: extractMetric("didin_api_response_time_avg_ms"),
    api_requests_total: extractMetric("didin_api_requests_total"),
    api_errors_5xx: extractMetric("didin_api_errors_5xx_total"),
    api_errors_4xx: extractMetric("didin_api_errors_4xx_total"),
    rate_limit_blocked: extractMetric("didin_rate_limit_blocked_total"),
    youtube_quota_used: extractMetric("didin_youtube_quota_used"),
    youtube_quota_limit: extractMetric("didin_youtube_quota_limit"),
    platforms: {
      youtube: {
        sessions: extractMetric("didin_platform_sessions_active", 'platform="youtube"'),
        posts_today: extractMetric("didin_platform_posts_today", 'platform="youtube"'),
      },
      instagram: {
        sessions: extractMetric("didin_platform_sessions_active", 'platform="instagram"'),
        posts_today: extractMetric("didin_platform_posts_today", 'platform="instagram"'),
        challenges: extractMetric("didin_instagram_challenges_pending"),
      },
      tiktok: {
        sessions: extractMetric("didin_platform_sessions_active", 'platform="tiktok"'),
        posts_today: extractMetric("didin_platform_posts_today", 'platform="tiktok"'),
      },
      whatsapp: {
        sessions: extractMetric("didin_platform_sessions_active", 'platform="whatsapp"'),
        messages_today: extractMetric("didin_platform_posts_today", 'platform="whatsapp"'),
      },
    },
  };
}
