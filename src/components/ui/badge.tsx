...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2 py-0.5 text-[11px] font-semibold transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
        ...
        outline: "text-foreground border-border/60 hover:bg-accent/80",
        success:
        ...
        tiktrend:
          "border-transparent bg-gradient-to-r from-tiktrend-primary to-tiktrend-secondary text-white shadow-sm shadow-tiktrend-primary/15 animate-gradient",
        new:
