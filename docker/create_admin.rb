# Criar conta e usuário admin para Didin Fácil
account = Account.find_or_create_by!(name: 'Didin Facil') do |a|
  a.locale = 'pt_BR'
end

user = User.find_or_create_by!(email: 'admin@didin.local') do |u|
