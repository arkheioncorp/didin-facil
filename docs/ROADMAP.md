...
### Milestone 1.0: Produto Mínimo Viável

**Objetivo:** Aplicativo funcional com busca de produtos, filtros básicos e sistema de assinatura.
...
- Inicializar projeto Tauri + React
...
|----|--------|-------------|--------|------------|
| 1.1 | Criar repositório GitHub | Dev | 🔲 | P0 |
| 1.2 | Setup Tauri 2.0 + React 18 | Dev | 🔲 | P0 |
| 1.3 | Configurar TypeScript + ESLint | Dev | 🔲 | P0 |
| 1.4 | Setup Tailwind CSS + shadcn/ui | Dev | 🔲 | P0 |
| 1.5 | Configurar Vite | Dev | 🔲 | P0 |
| 1.6 | Setup Python environment (scraper) | Dev | 🔲 | P0 |
| 1.7 | Configurar GitHub Actions (CI) | DevOps | 🔲 | P1 |
| 1.8 | Criar estrutura de pastas | Dev | 🔲 | P0 |
| 1.9 | Setup Zustand + React Query | Dev | 🔲 | P1 |
| 1.10 | Documentação inicial (README) | Dev | 🔲 | P1 |

**Entregáveis:**
- [x] Projeto buildando sem erros
- [x] Hot reload funcionando
- [x] CI rodando testes básicos

**Critérios de Aceite:**
- `npm run dev` inicia o app
- `npm run tauri dev` abre a janela desktop
- Build passa no GitHub Actions
...
| ID | Tarefa | Responsável | Status | Prioridade |
|----|--------|-------------|--------|------------|
| 2.1 | Layout principal (Header, Sidebar, Content) | Dev | 🔲 | P0 |
| 2.2 | Sistema de rotas (React Router) | Dev | 🔲 | P0 |
| 2.3 | Página Dashboard (skeleton) | Dev | 🔲 | P0 |
| 2.4 | Componente ProductCard | Dev | 🔲 | P0 |
| 2.5 | Componente ProductGrid | Dev | 🔲 | P0 |
| 2.6 | Barra de busca | Dev | 🔲 | P0 |
| 2.7 | Toggle dark/light mode | Dev | 🔲 | P1 |
| 2.8 | Componente Loading states | Dev | 🔲 | P1 |
| 2.9 | Componente Empty states | Dev | 🔲 | P1 |
| 2.10 | Responsive design básico | Dev | 🔲 | P1 |

**Entregáveis:**
- [x] Layout navegável
- [x] Cards de produto com dados mock
- [x] Dark mode funcionando

**Critérios de Aceite:**
- Navegação entre páginas funcional
- ProductCard exibe: imagem, título, preço, métricas
- UI responsiva em diferentes tamanhos de janela
...
**Objetivos:**
- Implementar painel de filtros completo
- Iniciar desenvolvimento do scraper Python
- Integrar Playwright
...
| ID | Tarefa | Responsável | Status | Prioridade |
|----|--------|-------------|--------|------------|
| 3.1 | Painel de filtros lateral | Dev | 🔲 | P0 |
| 3.2 | Filtro por categoria (multi-select) | Dev | 🔲 | P0 |
| 3.3 | Filtro por preço (range slider) | Dev | 🔲 | P0 |
| 3.4 | Filtro por vendas | Dev | 🔲 | P0 |
| 3.5 | Filtros toggles (frete grátis, etc) | Dev | 🔲 | P1 |
| 3.6 | Setup Playwright no Python | Dev | 🔲 | P0 |
| 3.7 | Scraper TikTok Shop básico | Dev | 🔲 | P0 |
| 3.8 | Parser de produtos | Dev | 🔲 | P0 |
| 3.9 | Download de imagens | Dev | 🔲 | P1 |
| 3.10 | Integração Tauri ↔ Python (sidecar) | Dev | 🔲 | P0 |

**Entregáveis:**
- [x] Filtros funcionais no frontend
- [x] Scraper coletando produtos reais
- [x] Comunicação Rust ↔ Python funcionando

**Critérios de Aceite:**
- Filtros atualizam contagem de resultados
- Scraper retorna JSON com produtos válidos
- Imagens são baixadas para cache local
