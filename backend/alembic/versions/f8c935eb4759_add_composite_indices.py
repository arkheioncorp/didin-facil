...
def downgrade() -> None:
    ...
    op.add_column('payments', sa.Column('license_id', postgresql.UUID(as_uuid=True), autoincrement=False, nullable=True))
    ...
    sa.Column('id', postgresql.UUID(as_uuid=True), server_default=sa.text('uuid_generate_v4()'), autoincrement=False, nullable=False),
    ...
    sa.Column('product_id', postgresql.UUID(as_uuid=True), autoincrement=False, nullable=False),
